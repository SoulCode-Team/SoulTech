...
import com.SoulSkin.soultech.item.*;
...
public class soultech {
    ...
    public static ItemArmor.ArmorMaterial soulSteelArmor = EnumHelper.addArmorMaterial("soulSteel", 200, new int[]{3, 8, 7, 4}, 15);
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        ModLogger.info(versionHandler.getVersionMessage());
    ...
    public void init(FMLInitializationEvent event) {
        ...
        if (Reference.GOOGLE_KEY != "@G_KEY@" && StringUtils.isNullOrEmpty(GDK)) {
...
//                areaDeathRegistery.addEntityToBlacklist(imcMessage.getStringValue());
    ...
    //    @Mod.EventHandler
    public void deprecationHandler(FMLMissingMappingsEvent event) {
