...
public class weathermansCompass extends baseModTool {
	...
	public void registerIcons( IIconRegister par1registerIcon ) {
		...
		this.itemIcon0 = par1registerIcon.registerIcon( Reference.MOD_ID + ":" + Reference.TOOL_FOLDER + this.getUnlocalizedName() + "_Sun" );
		this.itemIcon1 = par1registerIcon.registerIcon( Reference.MOD_ID + ":" + Reference.TOOL_FOLDER + this.getUnlocalizedName() + "_Rain" );
		this.itemIcon2 = par1registerIcon.registerIcon( Reference.MOD_ID + ":" + Reference.TOOL_FOLDER + this.getUnlocalizedName() + "_Thunder" );
		this.itemIcon3 = par1registerIcon.registerIcon( Reference.MOD_ID + ":" + Reference.TOOL_FOLDER + this.getUnlocalizedName() + "_Lighting" );
	}
