...
import com.SoulSkin.soultech.util.chatUtils;
                ...
                if (stack.hasTagCompound() && stack.stackTagCompound.getString("status").equals("tooltips.status.activated")) {
                    ...
                    for (int i = 1; i < worldIn.loadedEntityList.size(); i++) {
                        ...
                        if (entity.getDistanceToEntity(ePlayer) <= radius && (entity instanceof IMob || entity instanceof EntityWither || entity instanceof EntityDragonPart)) {
                            ...
                            worldIn.spawnParticle("portal", ePlayer.posX, ePlayer.posY - 1, ePlayer.posZ, (entity.posX - ePlayer.posX) / 1, (entity.posY - ePlayer.posY) / 1, (entity.posZ - ePlayer.posZ) / 1);
                            worldIn.spawnParticle("flame", ePlayer.posX, ePlayer.posY - 1, ePlayer.posZ, (entity.posX - ePlayer.posX) / 9, (entity.posY - ePlayer.posY) / 9, (entity.posZ - ePlayer.posZ) / 9);
//						worldIn.spawnParticle( "blockcrack_" + Block.getIdFromBlock(Blocks.obsidian) + "_0", ePlayer.posX, ePlayer.posY, ePlayer.posZ, ( entity.posX - ePlayer.posX )/2, ( entity.posY - ePlayer.posY )/2, ( entity.posZ - ePlayer.posZ )/2 );
    ...
    public void registerIcons(IIconRegister par1registerIcon) {
        ...
        this.itemDisableIcon = par1registerIcon.registerIcon((ModTextures.GetTextureNameFull(this, Reference.TOOL_FOLDER)).replace(Reference.IMG_EXTENSION, "") + "_disabled");
    }
