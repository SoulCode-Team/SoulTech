 ...
 */
public class baseModShovel extends ItemSpade {

    public static Item materialItem;

    public baseModShovel(Item.ToolMaterial mat, Item matItem, String itemName) {
        super(mat);
        this.setCreativeTab(STTAB);
        this.setUnlocalizedName(itemName + "_Shovel");
        this.materialItem = matItem;
    }
